...
- **Official Candidate — 2026 Python Packaging Council Election** — Listed by Python.org as a nominee for the inaugural Python Packaging Council, the technical governance body responsible for interoperability standards governing how Python packages are built, distributed and installed.
- **Official source:** [Python.org nominee profile](https://www.python.org/nominations/elections/2026-python-packaging-council/nominees/saurav-singla/)

## Global Fintech Fest 2025 AI Report

- **Global Fintech Fest 2025 AI Report** — Featured expert cited for perspectives on Graph AI-based money-mule detection, model drift, retraining and false-positive reduction.
- The reference appears on **page 11** of the report.
- **Source:** [Global Fintech Fest 2025 AI Report](https://www.eoiparis.gov.in/content/GFF2025_paris_event_13_03_2026_02.pdf)
